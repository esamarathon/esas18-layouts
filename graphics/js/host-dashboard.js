...
$(() => {
	...
	var streamChannel = !nodecg.bundleConfig.stream2 ? 'esamarathon' : 'esamarathon2';

	$('#streamEmbed').attr('src', 'https://player.twitch.tv/?channel='+streamChannel);
	$('#chatEmbed').attr('src', 'https://www.twitch.tv/embed/'+streamChannel+'/chat?darkpopout');
